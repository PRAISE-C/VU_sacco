...
PreparedStatement pst;
    ...
    private void initComponents() {
        ...
        Versiontxt.setText("VICTORIA UNIVERSITY HYBRIDS.");

        jList1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "1. ABAASA ALBERT", "2. MUGABI BENJAMIN", "3. MULUNGI JOEL JEWELS", "4. MASABA MARVIN", "5. ODONGO EMMANUEL", "6. MASEREKA PRAISE", "7. MURAGO KANYORO SAMUEL" };
